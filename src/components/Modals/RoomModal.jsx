...
function RoomModal({ setOpenModal, message, type, room, handlegetRooms }) {
	...
	return (
		<div
			className="closingClass animate-fadeIN bg-[#000000b3] flex-col fixed items-center justify-center h-[100vh] z-[99]"
			style={{ display: "flex", transition: ".3s", inset: "0" }}>
				...
				{type == "failure" ? (
					<>
						<div className="flex flex-col items-center">
							...
							<p className="text-center w-[100%] text-lg text-red-400 font-bold">
								Error
							</p>
						</div>
					</>
				...
				{type == "loading" ? (
					...
					<>
								...
								<form onSubmit={handleFormSubmit}>
									<div className="relative p-4 border-2 flex flex-col animate-fadeUP1">
										...
										<div className="form styled-input mt-[10px] min-[701px]:w-[50vw] max-w-[400px] animate-fadeUP1">
											...
											/>
											<label className="rounded-t-[20px] px-4">
												Photo URL*
											</label>
										</div>
										...
										<div className="flex justify-between">
											<div className="form mt-[10px] w-[45%] animate-fadeUP1 flex flex-col-reverse p-2 border-[1px] border-black rounded-2xl bg-white text-center ">
												<input
													type="number"
													className="text-center h-[30px] text-2xl outline-none"
													name="pax"
													min="1"
													max="3"
													required
						...
						{type == "loading" ? (
							...
							<button
								className="closingClass px-6 py-3 bg-gradient-to-t from-gray-200 to-transparent hover:contrast-[2] hover:scale-[1.05] hover:brightness-[1.2] ease-in duration-300 shadow-md shadow-gray-900/30 rounded-xl"
