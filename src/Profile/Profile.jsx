			...
			<main className="w-[100%] flex flex-col items-center gap-2">
				<form onSubmit={handleSubmit}>
					<div className="relative p-4 border-2 flex flex-col gap-2 animate-fadeUP1">
						...
						<div className="form styled-input max-[700px]:w-[80vw] min-[701px]:w-[50vw] max-w-[400px]  animate-fadeUP2">
							<input type="text" name="photo" value={PhotoTemp} onChange={handleChange} required/>
							<label>Avatar</label>
						</div>
				...
				<div className="my-5 border-2 p-4 flex flex-col items-center w-[436px] max-[539px]:w-[80vw] animate-fadeUP1">
					<p className="text-center border-b-2 border-b-red-400 font-bold w-[100%]">User Traits</p>
					{/* start of traits */}
					{!nameAttr && 
						<p>Questionnaire not filled in!</p>
					}
					{nameAttr && 
					<>
					<div className="flex flex-nowrap whitespace-nowrap w-[200px] items-center animate-fadeUP1">
						...
						<span className="basis-1/2 h-[10px] w-[100%] bg-gradient-to-r from-red-200 via-yellow-200 to-green-200 relative rounded-xl">
							<span className="h-[100%] bg-gradient-to-r from-blue-600 to-green-600 absolute left-0 rounded-xl text-end leading-[9px] text-xs" style={{width: parseInt(`${nameAttr["Clean"]}%`) * 20}}></span>
						</span>
					</div>
					...
					<div className="flex flex-nowrap whitespace-nowrap w-[200px] items-center animate-fadeUP1">
						...
						<span className="basis-1/2 h-[10px] w-[100%] bg-gradient-to-r from-red-200 via-yellow-200 to-green-200 relative rounded-xl">
							<span className="h-[100%] bg-gradient-to-r from-blue-600 to-green-600 absolute left-0 rounded-xl text-end leading-[9px] text-xs" style={{width: parseInt(`${nameAttr["Friendly"]}%`) * 20}}></span>
						</span>
					</div>
					...
					<div className="flex flex-nowrap whitespace-nowrap w-[200px] items-center animate-fadeUP1">
						...
						<span className="basis-1/2 h-[10px] w-[100%] bg-gradient-to-r from-red-200 via-yellow-200 to-green-200 relative rounded-xl">
							<span className="h-[100%] bg-gradient-to-r from-blue-600 to-green-600 absolute left-0 rounded-xl text-end leading-[9px] text-xs" style={{width: parseInt(`${nameAttr["Drinking"]}%`) * 20}}></span>
						</span>
					</div>
					...
					<div className="flex flex-nowrap whitespace-nowrap w-[200px] items-center animate-fadeUP1">
						...
						<span className="basis-1/2 h-[10px] w-[100%] bg-gradient-to-r from-red-200 via-yellow-200 to-green-200 relative rounded-xl">
							<span className="h-[100%] bg-gradient-to-r from-blue-600 to-green-600 absolute left-0 rounded-xl text-end leading-[9px] text-xs" style={{width: parseInt(`${nameAttr["Responsable"]}%`) * 20}}></span>
						</span>
					</div>
					...
					<div className="flex flex-nowrap whitespace-nowrap w-[200px] items-center animate-fadeUP1">
						...
						<span className="basis-1/2 h-[10px] w-[100%] bg-gradient-to-r from-red-200 via-yellow-200 to-green-200 relative rounded-xl">
							<span className="h-[100%] bg-gradient-to-r from-blue-600 to-green-600 absolute left-0 rounded-xl text-end leading-[9px] text-xs" style={{width: parseInt(`${nameAttr["Smoking"]}%`) * 20}}></span>
						</span>
					</div>
					</>
					}
				...
				<NavLink to="/questionnaire" activeclassname={"active"}><span className="bg-gradient-to-b from-red-400 to-transparent hover:scale-[1.05] hover:contrast-[1.2] ease-in duration-300 shadow-md shadow-gray-900/30 rounded-xl py-2 px-4 cursor-pointer font-bold">&#62;&#62; {nameAttr ? "Reset" : "Add"} Traits &#60;&#60;</span></NavLink>
