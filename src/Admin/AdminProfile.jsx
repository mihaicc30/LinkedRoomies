				...
				<div className="relative p-4 border-2 flex flex-col gap-2 animate-fadeUP1">
					...
					<div className="form styled-input  max-w-[400px]  animate-fadeUP2">
						<input
							...
							required
							defaultValue={email}
							className="select-none text-[grey!important] bg-[#dad9d9!important]"
						/>
						<label className="bg-[#dad9d9!important] rounded-[12px] w-[fit-content]">
							Email*
						</label>
						<span
							className="absolute w-[100%] h-[100%] z-[2]"
							style={{ WebkitUserDrag: "none", userSelect: "none" }}></span>
					</div>
